...
def regresionLogisticaEntrenarMejorado(X,y,X_test, y_test,validacion_X, validacion_y, regurlarizacion = 'l2' , ajuste = 1):
    ...
    tasa_acierto_train = model.score(X,y)
    return tasa_acierto, tasa_acierto_train,model.score(validacion_X,validacion_y), model.predict(X_test)
...
def primerDataSet():
    ...
    start_time = time()
    acieto_test, acierto_train, acierto_validacion, y_predecido_mejorada = regresionLogisticaEntrenarMejorado(train_X,train_y,test_X,test_y,validacion_X, validacion_y,regularizacion,100)
    print("Regresion logistica")
    print("Tiempo=", time() - start_time )
    print("Ein = ",(1-acierto_train)*100)
    print("Eout = ",(1-acieto_test)*100)
    print("Error particion validacion = ", (1-acierto_validacion))
